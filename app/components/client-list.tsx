...
export default function ClientList({ onAddNew, onSelectClient }: ClientListProps) {
      ...
      {loading ? (
              ...
              <TableRow key={client.id}>
                ...
                <TableCell className="text-right">
                  <div className="flex justify-end gap-2">
                    <Button variant="outline" size="icon" onClick={() => onSelectClient(client)}>
        ...
        <Card>
          ...
          <CardContent className="text-center">
            <p className="text-muted-foreground mb-4">No se encontraron clientes en el sistema</p>
            <Button onClick={onAddNew}>
